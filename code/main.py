...
def read_data_and_clean_data(data_dir):
    ...
    nces_data = pd.read_excel(excel_file, sheet_name="Digest 2022 Table 323.10", skiprows=2)
    if nces_data.empty:
        raise ValueError("tabn323.10.xlsx is empty or does not contain the expected data")
    ...
    math_stats_row = nces_data[nces_data["Field of study"] == "Mathematics and statistics"]
